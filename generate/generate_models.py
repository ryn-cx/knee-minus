# TODO: Validate
"""Rebuilds every KneeMinus model from the responses recorded under `_files`.
...
# TODO: Validate
def generate_all(client: KneeMinus) -> None:
...
if __name__ == "__main__":
    ...
    generate_all(KneeMinus(build_client_automatically()))
